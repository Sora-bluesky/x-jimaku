...
- **Non-target video.** Open a video the extension does not treat as a target (e.g. a muted or otherwise excluded video). A `対象外` badge appears in place of the subtitle bar — confirm no bar renders and no ASR activity starts for that video.
